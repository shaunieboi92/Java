...
public class ScraperYahoo4 {
	...
	public static void retrieveStockInfo(List<String> Quotes) {
		...
		for(String quote: Quotes) {
			try {
				Document doc = Jsoup.connect("https://finance.yahoo.com/quote/" + quote + ".SI").userAgent("Mozilla").get();
				if(doc==null) {
				...
				//get the root element
					if(x==null) {
						...
						if(line.contains("Currency")) {
							...
							System.out.println("The Price of " + quote.toUpperCase() + " is " + showCurrency + line.substring(start-1, start +5));
						}
